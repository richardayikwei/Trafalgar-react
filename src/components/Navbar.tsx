  ...
  return (
    <nav className="container mx-auto">
      <div className="flex flex-col md:flex-row md:justify-between">
        ...
        <div className="flex-col md:flex-row w-[160px] h-[41px] mt-[56px] ">
        ...
        <div className="flex flex-col md:flex-row md:space-x-[40px] ml-[40px] l w-[545px] h-[23px] mt-[70px] text-[18px] text-[#1F1534] ">
          <a
            href="#"
