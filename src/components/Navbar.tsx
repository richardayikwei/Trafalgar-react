  ...
  return (
    <nav>
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex-col md:flex-row w-[160px] h-[41px] mt-[56px] md:ml-[191px] ml-[50px]">
        ...
        <div className="flex flex-col md:flex-row space-x-10  w-[545px] h-[23px] mt-[70px] md:ml-[512px] ml-[50px] text-[18px] text-[#1F1534]">
          <a
            href="#"
